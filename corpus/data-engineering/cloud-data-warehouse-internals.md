...
- **Hybrid format** — like [[data-engineering/parquet|Parquet]]: data grouped into **row groups** (a horizontal partition of rows); within each, a column's data is a **column chunk** (vertical partition). Used by BigQuery (Capacitor), Snowflake, and Databricks (Parquet/Delta).
...
- [[data-engineering/open-table-formats|Open Table Formats]] — Delta/Iceberg metadata layers
