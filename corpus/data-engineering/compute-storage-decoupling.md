...
- **Engines become interchangeable over shared bytes.** Decoupling is what makes [[data-engineering/open-table-formats|open table formats]] and multi-engine querying possible at all — the same Iceberg/Delta table read by several compute engines.
...
- [[data-engineering/cloud-data-warehouse-internals|Cloud Data Warehouse Internals]] — the warehouse-side deep comparison (this synthesis generalizes it across paradigms)
- [[data-engineering/storage-fundamentals|Storage Fundamentals]] — file/block/object storage; why object storage scales
- [[data-engineering/kafka|Apache Kafka]] — tiered/diskless storage; streaming's late convergence
- [[data-engineering/stream-processing|Stream Processing]] — the streaming paradigm context
- [[data-engineering/parquet|Apache Parquet]] · [[data-engineering/open-table-formats|Open Table Formats]] — the file + metadata layers that live in object storage
