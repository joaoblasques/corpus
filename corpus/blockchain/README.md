...
### Number Theory & Cryptographic Foundations
...
- [Yet Another Introductory Number Theory Textbook (Poritz, 2014)](/blockchain/sources/yet-another-introductory-number-theory-textbook.md) — source · draft · 128pp; modular arithmetic, congruences, RSA, discrete logarithms; complete (5/5 parts)
...
- [Jonathan A. Poritz](/blockchain/jonathan-poritz.md)
- [Satoshi Nakamoto](/blockchain/satoshi-nakamoto.md)

<details>
<summary>Source summaries (4)</summary>
...
- [Yet Another Introductory Number Theory Textbook (Poritz, 2014)](/blockchain/sources/yet-another-introductory-number-theory-textbook.md)
