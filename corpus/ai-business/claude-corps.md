...
Anthropic frames Claude Corps around three goals [^src1]:
- **Impact** — help organizations communities rely on (conservation groups, museums, social services) realize AI's potential despite limited resources.
- **Growth** — train early-career talent to build AI tools and systems that extend those organizations' missions.
- **Agency** — fellows gain lasting skills and experience; host organizations build new AI-era capabilities.

## How it works

- **Fellows** apply, get matched, and spend the next **12 months** embedded inside a US nonprofit — across social services, museums, mental health, and refugee support — building tools and systems alongside the teams they serve [^src1].
- **Host organizations** place a trained fellow inside their team for 12 months. Anthropic, CodePath, and Social Finance **cover salary, benefits, training, and ongoing support** [^src1].
...
[^src1]: [Claude Corps | Anthropic](../../raw/web/web-claude-corps.md)
