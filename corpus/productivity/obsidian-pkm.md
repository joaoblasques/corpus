...
## PARA for the AI era (Forte Labs)

Tiago Forte's 2026 framing: PARA is particularly well-suited to AI-assisted work because it provides pre-assembled, action-oriented context bundles that LLMs can be pointed at directly.[^src_fl]

Why PARA beats alternatives for AI context:[^src_fl]
- **Simple = LLM-friendly**: 4 categories encompassing anything; granular taxonomies are harder for both humans and AIs to navigate.
- **Project-centric = action-centric**: LLMs work best on action-oriented chunks, not taxonomic hierarchies. "Active projects" as first-class citizens keeps both you and your AI focused on doing, not hoarding.
- **Archives = structured forgetting**: memory has a cost; the Archives category lets LLMs de-prioritize completed work without destroying it — unlike flat folders that dump everything at once.
- **Cross-platform consistency**: same PARA structure across Obsidian, Google Drive, Notion, email — the AI sees the same organizational logic regardless of tool.

What LLMs still can't do: notice that a file on your desktop reminds you to take an action tangentially related to it. The human awareness that emerges from the act of filing is irreplaceable.[^src_fl]

See also [AI-Augmented Knowledge Work](/productivity/ai-augmented-knowledge-work.md) §12 for the full Forte Labs PARA+AI treatment.
...
[^src_fl]: [Why PARA Is the Key to the AI Era](../../raw/web/web-why-para-is-the-key-to-the-ai-era-forte-labs-34f6877a.md) — Tiago Forte, Forte Labs (2026)
