...
## Measuring personal growth: Chip Huyen's three heuristics

From an ML engineer's perspective on quantifying growth (not net worth or follower count):[^src9]

1. **Rate of change (3-6 year cycles)**: "Every 3-6 years, you become a different person. You work on different problems. Your lifestyle changes. The people you hang out with are different." Life has a circadian rhythm — schools are structured this way. Treat yourself as an investment; how long does it take you to "double"?

2. **Time to solve big problems**: "Three big problems in life: career, family, finance. It usually takes people a decade to figure each out." Goal: solve them faster to unlock bandwidth for more interesting problems. Concrete progress signals: problems you *no longer* worry about that you did 5 years ago.

3. **Empowerment maximization** (from reinforcement learning): "In the face of uncertainty, choose the action that maximizes future options." Applied to career: prefer jobs that pay less but give more options (open-source exposure, published work, transferable skills) over higher-paying niche roles. "I'd prioritize tasks that teach me transferable skills instead of tasks that teach me niche, narrow skills."[^src9]
